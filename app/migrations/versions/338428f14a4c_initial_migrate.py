...
Revision ID: 338428f14a4c
Revises: 
Create Date: 2023-09-09 19:44:35.842593
...
def upgrade():
    ...
    sa.Column('year_release', mysql.YEAR(), nullable=False),
    ...
    op.create_table('book_visits',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('book_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['book_id'], ['books.id'], name=op.f('fk_book_visits_book_id_books')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_book_visits_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_book_visits'))
    )
